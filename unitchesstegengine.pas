...
BEGIN
  ...
  IF attacke THEN BEGIN figurbedroht := figurbedroht+c1; IF ct < kleinsterwertangriff THEN kleinsterwertangriff:=ct END;
  ...
  IF attacke THEN BEGIN figurbedroht := figurbedroht+c1; IF cl < kleinsterwertangriff THEN kleinsterwertangriff:=cl END;
  ...
  IF attacke THEN BEGIN figurbedroht := figurbedroht+c1; IF cd < kleinsterwertangriff THEN kleinsterwertangriff:=cd END;
  ...
  IF attacke THEN BEGIN figurbedroht := figurbedroht+c1; IF ck < kleinsterwertangriff THEN kleinsterwertangriff:=ck END;
  ...
  IF attacke THEN BEGIN figurbedroht := figurbedroht+c1; IF cs < kleinsterwertangriff THEN kleinsterwertangriff:=cs END;
  ...
  IF attacke THEN BEGIN figurbedroht := figurbedroht+c1; IF cb < kleinsterwertangriff THEN kleinsterwertangriff:=cb END;
  ...
  attackeVerteidigt:=false;
    ...
    IF attackeVerteidigt THEN BEGIN figurverteidigt := figurverteidigt+c1; IF ct < kleinsterwertverteidigung THEN kleinsterwertverteidigung:=ct END;
    ...
    IF attackeVerteidigt THEN BEGIN figurverteidigt := figurverteidigt+c1; IF cl < kleinsterwertverteidigung THEN kleinsterwertverteidigung:=cl END;
    ...
    IF attackeVerteidigt THEN BEGIN figurverteidigt := figurverteidigt+c1; IF cd < kleinsterwertverteidigung THEN kleinsterwertverteidigung:=cd END;
    ...
    IF attackeVerteidigt THEN BEGIN figurverteidigt := figurverteidigt+c1; IF ck < kleinsterwertverteidigung THEN kleinsterwertverteidigung:=ck END;
    ...
    IF attackeVerteidigt THEN BEGIN figurverteidigt := figurverteidigt+c1; IF cs < kleinsterwertverteidigung THEN kleinsterwertverteidigung:=cs END;
    ...
    IF attackeVerteidigt THEN BEGIN figurverteidigt := figurverteidigt+c1; IF cb < kleinsterwertverteidigung THEN kleinsterwertverteidigung:=cb END;
     ...
     THEN
      BEGIN
       IF (kleinsterwertangriff <= aktuellefigur^.art)
           (*
           OR
           ((kleinsterwertangriff = aktuellefigur^.art) AND (kleinsterwertangriff< kleinsterwertverteidigung))
           *)
       THEN figurgef:=true;
      END
...
END;
 ...
 BEGIN (*alphabeta*)
	...
	BEGIN
        ...
        IF ((aktuell^.geschlagen<>NIL)AND(figurgef(aktuell^.nachpos,aktuell^.geschlagen)))
 ...
 FUNCTION computerzug (farbe, alpha, beta, tiefe, maxTiefe: INTEGER;linie:STRING): INTEGER;
  ...
  BEGIN
 	...
 	BEGIN
         ...
         IF ((aktuell^.geschlagen<>NIL)AND(figurgef(aktuell^.nachpos,aktuell^.geschlagen)))
               THEN bewertung := (cmaxinteger-ck+aktuell^.geschlagen^.art)*farbe
